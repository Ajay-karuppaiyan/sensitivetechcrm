...
const QuotationEdit = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-indigo-100 via-indigo-50 to-indigo-100 flex flex-col items-center p-4">
        <div className="max-w-4xl w-full mt-24">
            {/* Page Header */}
            <h2 className="text-4xl font-bold mb-10 text-center text-white bg-gradient-to-r from-indigo-600 via-blue-500 to-indigo-600 rounded-lg py-4 shadow-lg">
                Edit Quotation
            </h2>
