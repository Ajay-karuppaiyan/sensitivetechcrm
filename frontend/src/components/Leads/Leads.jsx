      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="border border-blue-200 p-6 rounded-lg shadow-inner bg-indigo-50">
          <div className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium pb-2">Contact:</label>
              <input
                type="tel"
                name="contact"
                value={lead.contact}
            ...
            <div>
              <label className="block text-sm font-medium pb-2">Company:</label>
              <input
                type="text"
                name="company"
                value={lead.company}
            ...
            <div>
              <label className="block text-sm font-medium pb-2">Location:</label>
              <input
                type="text"
                name="location"
                value={lead.location}
        ...
        <div className="border border-blue-200 p-6 rounded-lg shadow-inner bg-indigo-50">
          <div className="space-y-6">
            <div>
              <label className="block text-sm font-medium pb-2">Requirements:</label>
              <textarea
                name="requirements"
            ...
            <div>
              <label className="block text-sm font-medium pb-2">Comments:</label>
              <textarea
                name="comments"
                value={lead.comments}
                onChange={handleChange}
            ...
            <div>
              <label className="block text-sm font-medium pb-2">Status:</label>
              <select
                name="status"
                value={lead.status}
                onChange={handleChange}
